...
class Image(object):
    ...
    def __init__(self, w, h, scale,  zmax=None, array = None, channels=1, depth=8):
    ...
    def copy(self, channels=None, depth=None):
        ...
        out = self.__class__(
            self.width, self.height, self.scale, None,None,
    ...
    def threshold(self, z):
        ...
        out = self.__class__(self.width, self.height, self.scale, channels=1, depth=8)
